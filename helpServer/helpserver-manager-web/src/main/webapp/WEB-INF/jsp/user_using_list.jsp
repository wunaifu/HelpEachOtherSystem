                                                ...
                                                <tr>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${item.permission==0}">
                                                            <td style="color: red"><b>未实名认证</b></td>
                                                        </c:when>
                                                        <c:when test="${item.permission==1}">
                                                            <td style="color: green"><b>已实名认证</b></td>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <td style="color: red"><b>被禁用</b></td>
                                                        </c:otherwise>
                                                    </c:choose>
                                                    <td><a href="getUserByUserId?userId=${item.userid}">详情</a></td>
                                                    <td><a href="#${item.userid}">重置密碼</a></td>
                                                    <td><a href="#${item.userid}">禁用</a></td>
